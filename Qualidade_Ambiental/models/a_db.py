...
if 0==1:
    from gluon import *
    from gluon import db, IS_IN_SET, IS_UPPER, IS_EMPTY_OR, IS_IN_DB, IS_NOT_IN_DB, IS_MATCH, a_db, db, auth, Auth, pegaDof
...
session.secure()
session.connect(request, response, cookie_key=',.~~Grnt861@10.7.0.28', compression_level=None)
